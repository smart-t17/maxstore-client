# maxstore API client library

Allows asynchronous requests to maxstore REST API and get results with native Promise or async/await. Work on browser and server.

Client include:
- maxstore API
- maxstore AJAX API
- maxstore Web Store API


Install with:

```
npm install maxstore-client
```
